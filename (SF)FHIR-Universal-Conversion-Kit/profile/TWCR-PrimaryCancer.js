...
module.exports.globalResource = {
    ...
    Condition: {
        ...
        meta: {
            profile: ["https://hapi.fhir.tw/fhir/StructureDefinition/twcr-sf-primary-cancer-profile"],
        },
        text: {
            status: "empty",
        ...
        extension: [
            {
                ...
                valueCodeableConcept: {
                    coding: [
                        {
                            system: "https://hapi.fhir.tw/fhir/CodeSystem/twcr-sf-histology-codesystem",
                            code: "8001",
            ...
            },
            {
                ...
                valueCodeableConcept: {
                    coding: [
                        {
                            system: "https://hapi.fhir.tw/fhir/CodeSystem/twcr-sf-behavior-code-codesystem",
                            code: "3",
                            display: "invasive",
                        },
                    ],
        ...
        //         coding: [
        //             {
        //                 system: "https://hapi.fhir.tw/fhir/CodeSystem/twcr-sf-primary-site-codesystem",
        //                 code: "C000",
        ...
        //         coding: [
        //             {
        //                 system: "https://hapi.fhir.tw/fhir/CodeSystem/twcr-sf-laterality-codesystem",
        //                 code: "0",
        //                 display: "不是成對器官",
        //             },
        //         ],
...
module.exports.fields = [
    ...
    // },
    {
        ...
        `);
            ...
            let displayValue = tools.searchCodeSystemDisplayValue("../TWCR_ValueSets/definitionsJSON/CodeSystem-twcr-sf-primary-site-codesystem.json", data);
    ...
    },
    {
        ...
        `);
            ...
            let displayValue = tools.searchCodeSystemDisplayValue("../TWCR_ValueSets/definitionsJSON/CodeSystem-twcr-sf-laterality-codesystem.json", data);
