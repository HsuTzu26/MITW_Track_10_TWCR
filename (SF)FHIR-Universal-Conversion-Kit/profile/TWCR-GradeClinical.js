...
module.exports.globalResource = {
    ...
    Observation: {
        ...
        meta: {
            profile: ["https://hapi.fhir.tw/fhir/StructureDefinition/twcr-sf-grade-clinical-profile"],
        },
        text: {
            status: "empty",
...
module.exports.fields = [
    ...
    },
    {
            ...
            let valueCodeableConcept = JSON.parse(`
      {
        "coding" : [
          {
            "system" : "https://hapi.fhir.tw/fhir/CodeSystem/twcr-sf-grade-clinical-codesystem",
            "code" : "code",
