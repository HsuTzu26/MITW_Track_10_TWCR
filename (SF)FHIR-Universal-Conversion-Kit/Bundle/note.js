...
(|V|)Create composition profile and reference
    (|V|)Get all of the profile uuid
    (|V|)Create composition profile
    (|V|)Create references
        (|V|)Get all of the profile that has "reference"
(|V|)Completely create bundle
    (**Including composition, resources, create references**)
3.POST to cylab FHIR Server
(|V|)Check bundle whether meet the FHIR formation
(|V|)POST to FHIR Server, be sure no problem

##Additional##
(|V|)Create automated F.U.C.K. execution
(|V|)Completely create references

***
create uuid form for profiles/templates 
