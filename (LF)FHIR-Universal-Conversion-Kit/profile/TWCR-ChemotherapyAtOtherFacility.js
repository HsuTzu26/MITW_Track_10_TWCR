...
// https://mitw.dicom.org.tw/IG/TWCR_LF/StructureDefinition-chemotherapy-at-other-facility-profile.html
// 此Profile的完整JSON範例檔:
// https://mitw.dicom.org.tw/IG/TWCR_LF/StructureDefinition-chemotherapy-at-other-facility-profile.profile.json.html

module.exports.globalResource = {
    // Should be resource name
    Procedure: {
        id: uuid["TWCR-ChemotherapyAtOtherFacility"],
        meta: {
            profile: ["https://hapi.fhir.tw/fhir/StructureDefinition/twcr-lf-chemotherapy-at-other-facility-profile"],
        },
        text: {
            status: "empty",
...
module.exports.fields = [
    {
        ...
        target: "Procedure.id",
        beforeConvert: (data) => {
            return `TWCR-ChemotherapyAtOtherFacility-${data}-${tools.getCurrentTimestamp()}`;
        },
    },
    {
        //外院化學治療
