        ...
        beforeConvert: (data) => {
            let valueCodeableConcept = JSON.parse(`
            {
                "valueCodeableConcept":{ 
                    "coding" : [
                    {
                    "system" : "https://mitw.dicom.org.tw/IG/TWCR/CodeSystem/clinical-t-codesystem",
                    "code" : "code",
                    "display" : "display"
                    }
                    ]
            ...
            let displayValue = tools.searchCodeSystemDisplayValue("../TWCR_ValueSets/definitionsJSON/CodeSystem-clinical-t-codesystem.json", data);
