        ...
        beforeConvert: (data) => {
            let SEQRTSUGCode = JSON.parse(`
            {
                "valueCodeableConcept" : {
                    "coding" : [
                        {
                        "system" : "https://mitw.dicom.org.tw/IG/TWCR/CodeSystem/sequence-of-radiotherapy-and-surgery-codesystem",
                        "code" : "code",
                        "display" : "display"
                        }
                    ]
            ...
            `);
            SEQRTSUGCode.valueCodeableConcept.coding[0].code = data;
            let displayValue = tools.searchCodeSystemDisplayValue("../TWCR_ValueSets/definitionsJSON/CodeSystem-sequence-of-radiotherapy-and-surgery-codesystem.json", data);
            SEQRTSUGCode.valueCodeableConcept.coding[0].display = displayValue;
