...
module.exports.globalResource = {
  ...
  Condition: {
    ...
    meta: {
      profile: [
        "https://hapi.fhir.tw/fhir/StructureDefinition/twcr-lf-primary-cancer-profile"
      ]
    },
    text: {
      status: "empty",
...
module.exports.fields = [
  ...
  },
  {
    ...
    beforeConvert: (data) => {
      ...
      `);
      BehaviorCode[0].extension[0].valueCodeableConcept.coding[0].code = data;
      ...
      BehaviorCode[0].extension[0].valueCodeableConcept.coding[0].display = displayValue;
