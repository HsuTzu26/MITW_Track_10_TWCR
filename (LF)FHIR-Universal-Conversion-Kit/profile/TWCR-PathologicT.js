    ...
    },
    {
        ...
        beforeConvert: (data) => {
            let valueCodeableConcept = JSON.parse(`
            {
                "coding" : [
                    {
                      "system" : "https://hapi.fhir.tw/fhir/CodeSystem/twcr-lf-pathologic-t-codesystem",
                      "code" : "1A",
                      "display" : "T1a"
                    }
                  ]
            ...
            let displayValue = tools.searchCodeSystemDisplayValue("../TWCR_ValueSets/definitionsJSON/CodeSystem-twcr-lf-pathologic-t-codesystem.json", data);
