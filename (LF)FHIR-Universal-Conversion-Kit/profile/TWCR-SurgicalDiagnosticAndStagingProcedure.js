...
// https://mitw.dicom.org.tw/IG/TWCR_LF/StructureDefinition-surgical-diagnostic-and-staging-procedure-profile.html
// 此Profile的完整JSON範例檔:
// https://mitw.dicom.org.tw/IG/TWCR_LF/StructureDefinition-surgical-diagnostic-and-staging-procedure-profile.profile.json.html

module.exports.globalResource = {
    // Should be resource name
    Procedure: {
        id: uuid["TWCR-SurgicalDiagnosticAndStagingProcedure"],
        meta: {
            profile: ["https://hapi.fhir.tw/fhir/StructureDefinition/twcr-lf-surgical-diagnostic-and-staging-procedure-profile"],
        },
        text: {
            status: "empty",
...
module.exports.fields = [
    {
        ...
        target: "Procedure.id",
        beforeConvert: (data) => {
            return `TWCR-SurgicalDiagnosticAndStagingProcedure-${data}-${tools.getCurrentTimestamp()}`;
        },
    },
    {
        //申報醫院診斷性及分期性手術處置
